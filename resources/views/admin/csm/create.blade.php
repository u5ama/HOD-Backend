    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-default">
                <form class="box-body validate-me" action="{{url('/admin/csm-create')}}" method="POST" enctype="multipart/form-data" id="csmCreate">
                    @csrf
                        ...
                        <div class="col-sm-12">
                            <div class="col-sm-8">
                                <div class="col-sm-6 input-field">
                                    <label>Name</label>
                                    <input type="text" class="form-control" id="title" name="user_name" value="" data-required="true">
                                    <span class="help-block hide-me"><small></small></span>
                                </div>

                                <div class="col-sm-6 input-field">
                                    <label>Email</label>
                                    <input type="email" class="form-control" id="title" name="email" value="" data-required="true">
                                    <span class="help-block hide-me"><small></small></span>
                                </div>

                                <div class="col-sm-6 input-field">
                                    <label>Phone</label>
                                    <input type="tel" class="form-control" id="title" name="phone_number" value="" data-required="true">
                                    <span class="help-block hide-me"><small></small></span>
                                </div>
